...
public class Libreria {
    ...
    public double getPrecioBase(String autor, String titulo) {
        int pos = libros.indexOf(new Libro(autor, titulo, 0)); // Ponemos precio 0 porque no influye
    ...
    public void remLibro(String autor, String titulo){
        int pos = libros.indexOf(new Libro(autor, titulo, 0)); // El precio no se usa podemos poner el que queramos
