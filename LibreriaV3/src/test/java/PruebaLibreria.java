...
public class PruebaLibreria {
    public static void main(String [] args) {
        // Estos son los autores en oferta
        // Se muestra por pantalla lo siguiente: los libros en oferta tienen más datos, correspondientes
        // al descuento por la oferta que los libros que no tienen la oferta.
